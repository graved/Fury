...
BINDING_NAME_FURY_DEMOSHOUT  = "Toggle Demoralizing Shout"
...
SLASH_FURY_SUNDERDIFF = "Max target difference in levels for using Sunder Armor is set to "
...
SLASH_FURY_FLURRYTRIGGER = "Rage level when to start using Hamstring to trigger procs set to "
...
HELP_ATTACKRAGE    = "/fury attackrage <number> - sets minimum rage required when using Heroic Strike or Cleave (default: 30)"
...
HELP_BERSERK       = "/fury berserk <number> - sets minimum percent of health required when using Berserk (default: 60)"
HELP_BLOODRA       = "/fury bloodrage <number> - sets minimum percent of health required when using Bloodrage (default: 50)"
HELP_CHARGE        = "/fury charge - will use charge or intercept sequence"
HELP_DANCE         = "/fury dance <number> - sets rage allowed to be wasted when switching stance (dancing) (default: 25)"
HELP_DEBUG         = "/fury debug - writes commands in log"
HELP_DEFAULT       = "/fury default - Reset all settings to DEFAULT"
HELP_DEMODIFF      = "/fury demodiff <number> - sets maximum level difference to use Demoralizing Shout (default: 7)"
HELP_SUNDERDIFF    = "/fury sunderdiff <number> - sets maximum level difference to use Sunder Armor (default: 7)"
HELP_DISTANCE      = "/fury distance - Gives distance to target"
HELP_FLURRYTRIGGER = "/fury flurrytrigger <number> - Set rage level, when to start using Hamstring when Flurry isn't up (default: 52)"
HELP_HAMSTRING     = "/fury hamstring <number> - sets maximum percent of health allowed when using Hamstring on NPCs (default: 40)"
HELP_HELP          = "/fury help - outputs available commands"
HELP_RAGE          = "/fury rage <number> - sets maximum rage allowed when using abilities to gain rage (default: 60)"
